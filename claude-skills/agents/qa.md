...
tick: >
  ...
  (B) #219 implementation pilot: run `list-pilot-candidates.sh --agent qa`.
...
auto-implements:
  - "label:bug + label:qa + label:needs-human-review + label:safe-to-automate + label:epic:*"
