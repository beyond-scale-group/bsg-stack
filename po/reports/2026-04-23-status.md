...
_Generated: 2026-04-23T00:27:13Z_
...
| Make every reporting agent's tick receipt a GitHub PR URL, never a local worktree path | #84 | **in_progress** | 1 open issue(s), 1 open PR(s) |
...
| **E3 agent-pr-contract** — every reporting agent opens a PR via `open-report-pr.sh`; tick receipts contain a GitHub URL, never a local path | #84, label:bug | **in_progress** | 7 open issue(s), 1 closed issue(s), 1 open PR(s) |
...
- [#191](https://github.com/beyond-scale-group/bsg-stack/pull/191) — feat(labels): agent bus labels + audit-labels.sh compliance check
- [#187](https://github.com/beyond-scale-group/bsg-stack/pull/187) — fix(open-report-pr): normalise abs vs relative paths in dirty-file guard (#137)
...
- [#187](https://github.com/beyond-scale-group/bsg-stack/pull/187) — fix(open-report-pr): normalise abs vs relative paths in dirty-file guard (#137) _(opened 2026-04-23T00:15:43Z; review: pending; checks: SUCCESS)_
